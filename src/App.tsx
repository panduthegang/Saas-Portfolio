        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div 
                key={index}
                className="p-8 border-2 border-black rounded-lg hover:bg-black hover:text-white transform hover:-translate-y-2 transition-all duration-300 group"
              >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <div 
                key={index}
                className="border-2 border-white rounded-lg overflow-hidden hover:bg-white hover:text-black transform hover:-translate-y-2 transition-all duration-300 group"
              >
            ...
            {[
              ...
              >
                ...
                <div className="pt-4 border-t-2 border-gray-300 group-hover:border-gray-600">
                  ...
                  <p className="text-gray-600 group-hover:text-gray-300">{testimonial.role}</p>
                </div>
              </div>
            ))}
          </div>
